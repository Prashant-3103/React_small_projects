...
<ErrorBlock title="failed to load events..."  message={error.info?.message || 'failed to fetch message please try again later'}/>
  </div>
...
<h2>Are you sure</h2>
<p>Do you really want to delete the event, this action cannot be undone</p>
